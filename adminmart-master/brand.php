    ...
    <div class="page-wrapper">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>';
                echo '<a href="./brand_edit.php?maSP=' . $row['MATH'] . '"><button class="btn btn-success btn-sm edit btn-flat"><i class="fa fa-edit"></i> Sửa</button></a>';
                echo '<a href="./brand_delete.php?maSP=' . $row['MATH'] . '"><button class="btn btn-danger btn-sm delete btn-flat"><i class="fa fa-trash"></i> Xoá</button></a>';
                echo '</td>';
                echo '</tr>';
            }
